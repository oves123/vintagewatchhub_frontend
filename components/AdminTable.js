              ...
              <tr>
                <td colSpan={headers.length + (onSelectAll ? 1 : 0)} className="px-6 py-32 text-center">
                  <div className="max-w-sm mx-auto flex flex-col items-center gap-4">
                    <div className="w-16 h-16 bg-slate-50 rounded-none flex items-center justify-center text-slate-300 mb-2">
                       <AlertCircle size={32} />
                    </div>
                    <div>
                    ...
                    {!Array.isArray(data) && data?.error && (
                      <div className="mt-4 py-2.5 px-5 bg-rose-50 border border-rose-100 rounded-none">
