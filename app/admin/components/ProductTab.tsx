                          ...
                          <div className="w-12 h-12 rounded-xl bg-background border border-border overflow-hidden flex-shrink-0 relative">
                            ...
                            {getMediaList(p).some(m => isVideo(m)) && (
                              <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                                <div className="w-5 h-5 rounded-full bg-surface/90 flex items-center justify-center shadow-sm">
                  ...
                  >
                    {isVideo(m) ? (
                      <div className="w-full h-full bg-foreground flex items-center justify-center">
                        <div className="w-6 h-6 rounded-full bg-surface/20 flex items-center justify-center">
