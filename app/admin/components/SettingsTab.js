      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        <div className="xl:col-span-8">
          <div className="bg-surface rounded-3xl border border-border shadow-sm overflow-hidden flex flex-col h-[70vh]">
            ...
            <textarea
              ...
              className="flex-1 p-8 focus:outline-none text-muted font-medium leading-relaxed resize-none custom-scrollbar"
        ...
        <div className="xl:col-span-4 space-y-6">
          <div className="bg-surface p-8 rounded-3xl border border-border shadow-sm">
             <h3 className="text-xs font-black text-foreground uppercase tracking-tight mb-4 flex items-center gap-2">
          ...
          <div className="bg-primary p-8 rounded-3xl shadow-xl">
