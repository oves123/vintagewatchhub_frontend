                   ...
                   <div className="flex justify-between items-start mb-8">
                      <div className="flex items-center gap-6">
                         ...
                         <div>
                            ...
                            <p className="text-[11px] font-bold text-primary mt-1 uppercase tracking-widest">{selectedProduct.category_name}</p>
                            <div className="flex gap-3 mt-4">
                               <span className="px-2 py-1 rounded text-[9px] font-bold uppercase tracking-wider bg-slate-900 text-white shadow-sm">â‚¹{parseFloat(selectedProduct.price).toLocaleString()}</span>
                         ...
                         <div className="pt-8 border-t border-slate-100 flex flex-col gap-3">
                            {selectedProduct.status !== 'approved' && (
                               <button 
                                  ...
                                  className="w-full py-4 bg-emerald-600 text-white rounded-none text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-emerald-100 hover:bg-emerald-700 transition-all"
                               >
                                  Authorize Listing
                               </button>
                            )}
                            <button 
                               ...
                               className="w-full py-4 bg-surface text-rose-600 rounded-none text-[10px] font-bold uppercase tracking-widest border border-rose-100 hover:bg-rose-600 hover:text-white transition-all font-sans"
                            >
