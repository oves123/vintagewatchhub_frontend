        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-4 py-3 bg-[#0B1221] border border-border/40 rounded-lg text-white focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all text-[13px]"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex justify-center py-4 px-4 border border-transparent rounded-lg shadow-none text-sm font-bold uppercase tracking-[0.2em] text-[#0B1221] bg-[#C5A059] hover:bg-[#B38F48] focus:outline-none focus:ring-1 focus:ring-[#C5A059] disabled:opacity-50 transition-all font-serif"
          >
